                ...
                if(i==0) {
                    ...
                    if(obj_Source.vertex_num == obj_POI.vertex_num) {
                        ...
                        for(int j=0; j<obj_Source.sides.size(); j++) {
                            ...
                            bool isEqual = true;
                            for(int k=0; k<obj_Source.sides.size(); k++) {
                                if(0.5*obj_POI.sides[k] != obj_Source.sides[k]) {
                                    isEqual = false;
                            ...
                            isEqual = true;
                            for(int k=0; k<obj_Source.sides.size(); k++) {
                                if(obj_POI.sides[k] != obj_Source.sides[k]) {
                                    isEqual = false;
                            ...
                            isEqual = true;
                            for(int k=0; k<obj_Source.sides.size(); k++) {
                                if(1.5*obj_POI.sides[k] != obj_Source.sides[k]) {
                                    isEqual = false;
